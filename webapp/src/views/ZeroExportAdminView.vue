        ...
        <form @submit="saveConfig">
            <CardElement :text="$t('zeroexportadmin.ZeroExportConfiguration')" textVariant="text-bg-primary">
                ...
                <InputElement
                    ...
                    v-model="cfg.minimal_production"
                    type="number"
                    min="40"
                    step="1"
                    :postfix="$t('zeroexportadmin.Watts')"
        ...
        <CardElement :text="$t('zeroexportadmin.ZeroExportStatus')" textVariant="text-bg-primary" add-space>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input
                        class="form-control"
                        :value="status.setpoint == null ? 'unavailable' : status.setpoint + ' W'"
                        disabled
                    />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input
                        class="form-control"
                        :value="status.grid_power == null ? 'unavailable' : status.grid_power + ' W'"
                        disabled
                    />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input class="form-control" :value="status.grid_power_age + ' s'" disabled />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input
                        class="form-control"
                        :value="status.grid_update_period == 0 ? 'unknown' : status.grid_update_period + ' ms'"
                        disabled
                    />
                </div>
            </div>
