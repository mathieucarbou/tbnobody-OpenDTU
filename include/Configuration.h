...
struct CONFIG_T {
    ...
    struct {
        ...
        uint32_t MinimalProduction; // Minimum output per inverter in watts.
        ...
        struct {
            ...
            uint32_t FailsafeTimeout; // Seconds until a stale Shelly LNM sample is treated as unavailable.
        } ShellyLnm;
        ...
        struct {
            ...
            uint32_t FailsafeTimeout; // Seconds until a stale MQTT sample is treated as unavailable.
        } Mqtt;
    } ZeroExport;
};
