...
#define ZEROEXPORT_MINIMAL_PRODUCTION 50U // Minimum output per inverter in watts
#define ZEROEXPORT_MINIMAL_PRODUCTION_MIN 40U
...
#define ZEROEXPORT_SHELLY_LNM_FAILSAFE_TIMEOUT 10U
#define ZEROEXPORT_SOURCE_MQTT 2U
#define ZEROEXPORT_MQTT_GRID_POWER_TOPIC ""
#define ZEROEXPORT_MQTT_FAILSAFE_TIMEOUT 30U
