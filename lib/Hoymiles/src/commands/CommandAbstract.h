...
public:
    ...
    // Returns a unique identifier of this command instance. Used to follow
    // a command through the log output (enqueue -> TX -> RX -> Success/Fail).
    uint32_t getCommandId() const { return _commandId; }
